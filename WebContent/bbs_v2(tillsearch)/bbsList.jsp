...
<table class="table table-hover list"
	style="margin: 10% 0; text-align: justify-content; font-size: medium;">
	<thead>
		<tr>
	...
	<%
		...
		*/
		...
		//전체 목록
		ArrayList<BbsDTO> list = dao.list(col, word);//리스트뽑는 함수사용
		if (list == null) {
			out.println("<tr>");
 ...
 %> 	<a
			href="bbsRead.jsp?	bbsno=<%=dto.getBbsno()%>&col=<%=col%>&word=<%=word%>"><%=dto.getSubject()%>
		</a>
