...
%> 	<a
	...
	<tr><!-- 페이징---------------- -->
		<td colspan="7">
	<%
		String paging= new Paging().paging3(rec, nowPage, recordPerPage, col, word, "bbsListRe.jsp");
		out.println(paging);				
	%>		
		</td>
	</tr><!-- 페이징 ------------------->
...
<table></table>
<a href="bbsListRe.jsp" style="width: auto; margin: auto; font-size: medium;">답변제외목록</a>
